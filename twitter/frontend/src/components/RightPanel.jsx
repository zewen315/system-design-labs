...
import { GitHubIcon, GlobeIcon, InfoIcon, LinkedInIcon } from "./icons";
...
export default function RightPanel() {
  ...
  return (
    <>
      ...
      >
        <InfoIcon className="right-panel-toggle__icon" />
      </button>

      <div
        className={`right-panel-backdrop ${open ? "right-panel-backdrop--open" : ""}`}
        onClick={() => setOpen(false)}
      />

      <aside
        className={`right-panel ${open ? "right-panel--open" : ""}`}
        onClick={(e) => {
      ...
      >
        ...
        <div className="widget-card">
          ...
          <p className="widget-card__text">
            ...
            event-driven timeline fan-out, and self-hosted object storage, all built to
            demonstrate real architectural trade-offs.
          </p>
